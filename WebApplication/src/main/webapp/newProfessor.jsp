...
<div class="container"> 
	<div class="row"> 
		<div class="col-md-6"> 
			<div class="card"> 
			<form action="CreateProfessor" class="box" method="POST"> 
				...
				<textarea  name="about" rows="4" cols="40" placeholder="CV"></textarea>
				<textarea  name="achievements" rows="4" cols="40" placeholder="Write about achievements"></textarea>
				<br>
