...
<nav  style="background-color:#3d3d5c; padding: 10px;">
   		...
   		<button class="btn btn-outline-success me-2"><a href="<%=request.getContextPath()%>/Grades" style="text-decoration:none; color:white;"> All Grades </a></button>
   		<button class="btn btn-primary"> <a href="<%=request.getContextPath()%>/Semester" style="text-decoration:none; color:white;"> Semester </a> </button>
